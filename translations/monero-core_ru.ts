...
<context>
    ...
    <message>
        ...
        <translation>ПРЕДУПРЕЖДЕНИЕ: Не используйте повторно свои ключи Leviar на другом форке, ЕСЛИ ТОЛЬКО этот форк не имеет встроенные средства защиты от компрометации введенных ключей. Подобные действия могут повредить вашей конфиденциальности.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Майнинг на вашем компьютере помогает обезопасить сеть Leviar. Чем больше людей майнят, тем сложнее атаковать сеть, и каждый майнер вносит свой вклад в этот процесс. &lt;br&gt; &lt;br&gt;Майнинг также дает вам небольшой шанс добыть несколько монет Leviar. Ваш компьютер будет искать хеши для решения блоков. Если вы найдете блок, то получите вознаграждение. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>С достаточным количеством Leviar</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Leviar</source>
        <translation>С недостаточным количеством Leviar</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;Этот QR-код включает выбранный вами ранее адрес и введенную ниже сумму. Поделитесь ним с другимим (ПКМ-&gt;Сохранить) так они смогут более легко отправить вам точную сумму.&lt;/p&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Leviar: </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Установить новую высоту для восстановления:</translation>
    </message>
    <message>
...
Старый файл, содержащий кеш кошелька будет переименован и сможет быть восстановлен позднее.
    ...
    <message>
        ...
        <translation>Введено неверное значение высоты для восстановления. Должно быть число.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать сторонний узел для подключения к сети Leviar. Менее безопасно, но более удобно.</translation>
    </message>
    <message>
        ...
        <translation>Чтобы получить список удаленных нод, введите &apos;Leviar remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранной ноде можно доверять.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Leviar или их клонов, которые смогут повторно использовать ключи Leviar.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Leviar потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Leviar.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных входов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Leviar и доступен на веб-сайте leviar.io, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн (и блокчейны клонов Leviar) самостоятельно, используя инструмент leviar-blockchain-blackball, чтобы создать список известных потраченых входов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями Leviar, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей Leviar позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от Leviar-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши Leviar безопасно.&lt;br&gt;Если вы не используете программное обеспечения от Leviar-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Leviar, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Leviar отправлены успешно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Почти готово - осталось немного настроить Leviar</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Leviar blockchain?</source>
        <translation>Запустить блокчейн Leviar?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Майнинг защищает сеть Leviar, а также платит небольшую награду за проделанную работу. Эта опция позволяет Leviar майнить, когда ваш компьютер включен и простаивает. Когда вы продолжите работать, он прекратит майнинг.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Для того чтобы обмениваться данными с сетью Leviar, ваш кошелек должен быть подключен к ноде Leviar. Для лучшей конфиденциальности рекомендуется запустить собственную ноду.                         &lt;br&gt;&lt;br&gt;                         Если у вас нет возможности запустить собственную ноду, подключитесь к удаленной ноде.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработка Leviar поддерживается исключительно пожертвованиями</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Журнал транзакций</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Leviar!</translation>
    </message>
    <message>
...
Индекс адреса траты: </translation>
    ...
    <message>
        ...
        <translation>Leviar успешно отправлены: %1 транзакция(й) </translation>
    </message>
    <message>
